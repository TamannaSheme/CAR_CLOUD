...
<li><a href="#"><i class="fa fa-sitemap"></i> Vehicles</a>
				...
				<li><a href="testimonials.php"><i class="fa fa-table"></i> Manage Comments</a></li>
		
				<li><a href="reg-users.php"><i class="fa fa-users"></i> Registered Users</a></li>
	
			<li><a href="update-contactinfo.php"><i class="fa fa-files-o"></i> Update Contact Information</a></li>
